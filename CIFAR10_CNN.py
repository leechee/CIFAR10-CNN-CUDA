...
# CNN (two layer) CIFAR10 is 32 x 32 pixels
class ConvNet(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(4 * 4 * 128, 64) # 10 is the output, we need 10 for the 10 digits of MNIST. 64 is the number of channels
...
plt.xlabel('Epochs')
plt.savefig('CIFAR10-CNN-CUDA/assets/loss.png') # saves 
plt.show()
...
plt.savefig('CIFAR10-CNN-CUDA/assets/matrix.png') # saves confusion matrix as png to assets
plt.show()
